...
def train_validate():
    ...
    model_opts.enableExecutableCaching("./cache_profile_pipeline")
    ...
    inference_opts.enableExecutableCaching("./cache_profile_pipeline")
    ...
    # print(unet)
    # print(unet.encoder1)
    # unet.encoder3 = poptorch.BeginBlock(unet.encoder3, ipu_id=1)
    # unet.decoder4 = poptorch.BeginBlock(unet.decoder4, ipu_id=2)
    # unet.encoder2 = poptorch.BeginBlock(unet.decoder2, ipu_id=3)

    dataset_train, dataset_valid = datasets("/localdata/datasets/image_segmentation/kaggle_3m/", image_size, aug_scale, aug_angle)
